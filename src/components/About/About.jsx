      ...
      <section className="box1">
        ...
        <div className="screen">
          ...
          <div className="screen__content">
            <div className="screen__content-left">
              <p className="screen__content-para">
                Hi, I'm Geetha Rashinkar Kumar! My journey into technology
                started with a love for problem-solving and building impactful
                solutions. <br />
                <br /> I hold a Bachelor's in IT and, after 2+ years of
                experience, recently completed a Diploma in Software
                Engineering. <br />
                <br />
                I’ve gained experience across various web development projects,
                focusing on creating dynamic applications and collaborating with
                teams to deliver high-quality results.
              </p>
            </div>
            <div className="screen__content-right">
              <p className="screen__content-para">
                Apart from coding, I love caring for plants, which brings me
                peace and balance. I’m also passionate about cooking, enjoying
                the creativity and relaxation it offers outside of my tech
                world. <br />
                <br />
                I'm always excited about new opportunities and collaborations,
                and I look forward to working with like-minded individuals to
        ...
        <section className="skillset-container">
          <div className="skillset">
            ...
            <br />
            <img className="cert" src={assets.pd1} alt="pd1" />
