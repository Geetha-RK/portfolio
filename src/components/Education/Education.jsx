        ...
        <div className="container">
          ...
          <div className="container__row">
            ...
            <section className="container__contents">
              ...
              <div
                className={`container__description ${
                  isVisible[2] ? "container__show" : ""
                }`}
              >
                <h3 className="container__title">
                  Software Developer at UST Global 💼
                </h3>
          ...
          <div className="container__row">
            ...
            <section className="container__contents">
              ...
              <div
                className={`container__description ${
                  isVisible[3] ? "container__show" : ""
                }`}
              >
                <h3 className="container__title">
                  Bachelors of Science and Technology, <br /> Information
                  Technology 🎓
                </h3>
                <br />
